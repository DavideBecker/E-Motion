...
function renderMap(sketch) {
    var showMap = function showMap(sketch) {
...
function setup() {
    ...
    getStreetColor = function getStreetColor() {
...
var Car = function () {
    ...
    _createClass(Car, [{
        ...
        key: "startShortMove",
        value: function startShortMove(from, to) {
        ...
        key: "startMoveWithoutPathfinder",
        value: function startMoveWithoutPathfinder(moveArray) {
...
var Emotion = function () {
    ...
    _createClass(Emotion, [{
        ...
        value: function startCharging() {
            ...
            this.startMoveWithoutPathfinder(graph.findShortestPath(stuttgart.node.id, allCities[floor(random(0, allCities.length))].node.id));
        }
    }, {
        key: "move",
        value: function move() {
